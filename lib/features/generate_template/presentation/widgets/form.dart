part of '../generate_template.dart';
...
class __FormState extends State<_Form> {
  ...
  String? _numericFormValidator(String? value, String formName) {
    ...
    if (intValue == null) return "$formName hanya bernilai number";
    if (intValue <= 0) return "$formName minimal bernilai 1";
    return null;
  }
  ...
  void _submit(BuildContext context) {
    ...
    if (currentState != null && currentState.validate()) {
      currentState.save();
      context.read<GenerateTemplateCubit>().submit(email, nomorSoal);
    }
  }
        ...
        children: [
          ...
          _FormFieldWrapper(
            ...
            child: BaseTextFormField(
                ...
                onSaved: (value) {
                  final intValue = value.toIntOrNull();
                  if (intValue != null) {
                    nomorSoal = intValue;
                  }
                },
                validator: (value) =>
                    _numericFormValidator(value, "Jumlah Soal"),
